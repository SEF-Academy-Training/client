...
export const ContactsInfoData = [
	...
	},
	{
		...
		type: 'text',
		description:
			'Headquarter: 30 Misr Helwan Road, Maadi .Egypt Branch: Greek Campus office106 El Tahrir Square.',
		descriptionAr:
			'المقر: 30 شارع مصر حلوان ، المعادي. الفرع: الحرم الجامعي اليوناني المكتب 106 ميدان التحرير.',
...
export const BlogData = [
	{
		...
		blogAr:
			'إسراء لوريم إيبسوم دولور سيت أميت، كونسيكتيتور الآدبية، سيد العمل الجدير بالاهتمام الوقتية المترتبة على العمل والحزن الأساسي. كلام فارغ وخالٍ من المعاناة. لا يمكن اعتبار أي حدث جدير بالاهتمام. بالتالي، يجب أن تُسَمَّى كل الأحداث الهامة بلا معنى أو هدف',
		img: BlogsFeatured,
	},
	{
		id: '02',
		...
		blogAr:
			'محمود لوريم إيبسوم دولور سيت أميت، كونسيكتيتور الآدبية، سيد العمل الجدير بالاهتمام الوقتية المترتبة على العمل والحزن الأساسي. كلام فارغ وخالٍ من المعاناة. لا يمكن اعتبار أي حدث جدير بالاهتمام. بالتالي، يجب أن تُسَمَّى كل الأحداث الهامة بلا معنى أو هدف',
		img: BlogsFeatured,
	},
	{
		id: '03',
		...
		blogAr:
			'إسماعيل لوريم إيبسوم دولور سيت أميت، كونسيكتيتور الآدبية، سيد العمل الجدير بالاهتمام الوقتية المترتبة على العمل والحزن الأساسي. كلام فارغ وخالٍ من المعاناة. لا يمكن اعتبار أي حدث جدير بالاهتمام. بالتالي، يجب أن تُسَمَّى كل الأحداث الهامة بلا معنى أو هدف',
		img: BlogsFeatured,
	},
	{
		id: '04',
		...
		blogAr:
			'هانافي لوريم إيبسوم دولور سيت أميت، كونسيكتيتور الآدبية، سيد العمل الجدير بالاهتمام الوقتية المترتبة على العمل والحزن الأساسي. كلام فارغ وخالٍ من المعاناة. لا يمكن اعتبار أي حدث جدير بالاهتمام. بالتالي، يجب أن تُسَمَّى كل الأحداث الهامة بلا معنى أو هدف',
		img: BlogsFeatured,
	},
	{
		id: '05',
...
export const addServicesDataHeaderUserDashboard = [
	// {
	//   id: 98,
	//   title: '',
	//   titleAr: ''
